...
//分頁導航
if(empty($_GET["searchdata"])){
    $sql_list="SELECT * FROM s_class WHERE vaild=1";
}else{
    $sql_list="SELECT * FROM s_class WHERE vaild=1 AND (order_id LIKE 
    '%$searchdata%' OR class_name LIKE 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="form-inline my-2 my-lg-0 col-5 p-0">
                        <label class="mr-2">關鍵字搜尋 :</label>
                        <input class="form-control mr-sm-2 col-5" type="text" placeholder="Search" aria-label="Search" name="searchdata">
                    ...
                    <!-- <form>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="inlineCheckbox2">課程名稱</label>
                        </div>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="card shadow mb-4 my-4">
                        <div class="card-header py-3 d-flex align-content-center justify-content-between my-1">
                            <h6 class="m-0  p-0 font-weight-bold text-primary">課程訂單列表</h6>
                            <button class="btn btn-outline-primary my-2 my-sm-0 py-0" type="button" data-toggle="modal"
                                data-target="#create_member">+ 新增課程訂單</button>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">新增課程訂單</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid" style="padding-bottom: 3rem">
                                            ...
                                            <!-- <div class="form-group col-10">
                                                ...
                                                <div class="form-group col-10">
                                                    <label for="e_class_name">課程名稱</label>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td scope="col" class="text-center">
                                                    <div class="form-check" onclick="select(<?php echo $test; ?>)">
                                                       
                                                            <input class="form-check-input position-static" type="checkbox" name="select_member"  id="<?= $row["order_id"]?>">
                                                        
                                                    </div>

                                            </td>                                            
                                            <td scope="row" class="text-center"><?=$row["order_id"] ?></td>
                                            <td scope="col" class="text-nowrap text-left"><?=$row["class_name"] ?></td>
                                            ...
                                            <th scope="col d-flex edit" class="text-nowrap text-center">
                                                <button class="btn btn-info my-2 my-sm-0 py-1 mr-1" type="button" data-toggle="modal"
                                                    data-target="#edit_s_class" onclick="edit_class(<?php echo $test; ?>)"><i class="far fa-edit"></i></button>
                        ...
                        <div class="d-flex justify-content-center ml-4">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a class="page-link" href="temp_class.php?page=<?php if ($page != 1) {
                                                                                        echo ($page - 1);
                                                                                    } else {
                                                                                        echo $page = 1;
                                    ...
                                    <?php for ($i=1; $i<=$total_page; $i++){?>
                                        ...
                                        <a class="page-link" href="temp_class.php?page=<?=$i?>&searchdata=<?= $searchdata ?>"><?=$i?></a></li>
                                        <?php  } ?>                

                                    <li class="page-item ">
                                        <a class="page-link" href="temp_class.php?page=<?php if ($page < $total_page) {
                                                                                        echo ($page + 1);
                                                                                    } else {
                                                                                        echo $page = 1;
                ...
                <!--修改-->
                <div class="modal fade" id="edit_s_class" tabindex="-1" role="dialog"
                            aria-labelledby="edit_s_classTitle" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">編輯課程訂單</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container-fluid" style="padding-bottom: 3rem">
                                            ...
                                            <!-- Page Heading -->
                                            <form action="revise_class.php" method="post">
                                            <div class="form-group col-4">
                                                    <label for="order_id">訂單編號</label>
                                                    <input id="a" type="text" class="form-control" name="a" readonly required
                                                         value="">
                                                </div>
                                                <div class="form-group col-10">
                                                    <label for="class_name">課程名稱</label>
                                                    <input id="class_name2" type="text" class="form-control" name="class_name2" required
                                                        placeholder="">
                                                </div>
                                                <div class="form-group col-6">
                                                    <label for="purchaser_id">訂購人id</label>
                                                    <input id="purchaser_id" type="text" class="form-control" name="purchaser_id" readonly required
                                                        placeholder="">
                                                </div>
                                                <div class="form-group col-6">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="order_paid">
                                                        <option id="order_paid" selected></option>
                                                        <option value="Yes" name="order_paid">yes</option>
                                                        <option value="No" name="order_paid">no</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-6">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="order_refunded">
                                                        <option id="order_refunded" selected></option>
                                                        <option value="Yes">yes</option>
                                                        <option value="No">no</option>
                                                    </select>
                                                </div>
...
<script>
    function edit_class(test){
        ...
        document.getElementById("class_name2").value = test["e_class_name"];
        ...
        document.getElementById("order_paid").innerHTML = test["e_order_paid"];
        document.getElementById("payment_date").value = test["e_payment_date"];
        document.getElementById("order_refunded").innerHTML = test["e_order_refunded"];
