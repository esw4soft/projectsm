                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 my-4">
                        <div class="card-header py-3 d-flex align-content-center justify-content-between my-1">
                            <h6 class="m-0  p-0 font-weight-bold text-primary">活動訂單列表</h6>
                                        ...
                                        <div class="container-fluid" style="padding-bottom: 3rem">
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input id="purchaser_id" type="text" class="form-control" name="purchaser_id" required readonly
                                                        placeholder="">
                                                </div>
                                                <div class="form-group col-6">
