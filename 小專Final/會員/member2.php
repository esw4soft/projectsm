                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 my-4">
                        <div class="card-header py-3 ">
                            <div class="d-flex align-content-center justify-content-between my-2 mx-0">
                                <h6 class="m-0 font-weight-bold text-primary">會員列表</h6>
                                <button class="btn btn-outline-primary my-2 my-sm-0 py-0" type="button" data-toggle="modal" data-target="#create_member">+ 新增會員</button>
                            </div>
                                        ...
                                        <div class="container-fluid" style="padding-bottom: 3rem">
                                            ...
                                            <form id="create_list">
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <input type="email" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Enter email" id="create_email" required>
                                                ...
                                                <div class="d-flex">
                                                    <div class="form-group col-6">
                                                        ...
                                                        <input type="password" class="form-control" id="create_password" name="password" placeholder="Password" required>
                                                    </div>
                                                    <div class="form-group col-6">
                                                        <label for="Password">再次輸入密碼</label>
                                                        <input type="password" class="form-control" name="repassword" id="create_repassword" placeholder="Password" required>
                                                    </div>
                                                </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <button class="btn btn-danger mb-sm-1 p-0 px-1 " type="submit" data-toggle="modal" data-target="#deleteAll">刪除所選項目</button>
                                <!--                                <form name="order_by" method="get"> style="display: none"-->
                                ...
                                <?php
                                if (!empty($_GET["search"])) {
                                    echo "<a href='member2.php' class='mx-2'>返回全部項目</a>";
                                };
                                ?>
                                ...
                                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                                    <thead class="text-center header thead-light">
                                        ...
                                        <th scope="col" class="text-nowrap">序號
                                            <!--                                        <button type="submit" class="order" onclick="orderBy()"><i class="fas fa-sort-numeric-down"></i></button>-->
                                            <!--                                            <button type="submit" class="order" onclick="orderBy()"><i class="fas fa-sort-numeric-down-alt"></i></button>-->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <?//=$row["member_gender"]?>
                                                    <!--</td>-->
                                                    <!--                                            <td scope="col" class="text-nowrap text-center">-->
                                                    <?//=$row["experience"]?>
                                                    <!--</td>-->
                                                    <!--                                            <td scope="col" class="text-nowrap text-center">-->
                                                    <?//=$row["member_create_date"]?>
                                                    <!--</td> -->
                                                    <!--                                            <td scope="col" class="text-nowrap text-center">-->
                                                    <?//=$row["member_edit_date"]?>
                                                    <!--</td>-->
                                                    <td scope="col d-flex edit" class="text-nowrap text-center">
                                                        <button class="btn btn-success my-2 my-sm-0 py-1 mr-1" type="button" data-toggle="modal" data-target="#inspect_member" onclick="inspect(<?php echo $row["member_id"]; ?>)"><i class="fas fa-eye"></i></button>
                                                        <button class="btn btn-info my-2 my-sm-0 py-1 mr-1" type="button" data-toggle="modal" data-target="#edit_member" onclick="checkUser(<?php echo $row["member_id"]; ?>)"><i class="far fa-edit"></i></button>
                                                        <button class="btn btn-warning my-2 my-sm-0 py-1" type="button" data-toggle="modal" data-target="#delete" onclick="askDelete(<?php echo $row["member_id"]; ?>)"><i class="fas fa-user-minus"></i></button>
                                                    </td>
                                                </tr>

                                        <?php   }
                                        } else {
                                            echo "<h3>沒有相符的搜尋結果!</h3>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
                                ...
                                <div class="container-fluid" style="padding-bottom: 3rem">
                                    ...
                                    <form action="php/do_update.php" method="post">
                                        <div class="form-group col-2">
                                            ...
                                            <input type="text" class="form-control" id="member_id" name="edit_id" value="" readonly>
                                        </div>
                                        <div class="d-flex">
                                            <div class="form-group col-6">
                                                <label for="member_name">姓名</label>
                                                <input type="text" class="form-control" id="member_name" name="edit_name" value="">
                                            </div>
                                            <div class="form-group col-6">
                                                <label for="member_account">帳號</label>
                                                <input type="text" class="form-control" id="member_account" name="edit_account" value="">
                                            </div>
                                        </div>
                                        <div class="form-group col-12">
                                            <label for="member_email">信箱</label>
                                            <input type="email" class="form-control" id="member_email" name="edit_email" aria-describedby="emailHelp" value="">
                                        ...
                                        <div class="d-flex">
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control" id="member_password" name="edit_password" value="">
                                            </div>

                                            <div class="form-group col-6">
                                                <label for="member_phone">電話</label>
                                                <input type="tel" class="form-control" id="member_phone" name="edit_phone" value="">
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <div class="form-group col-6">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="reset()">取消</button>
                                        </div>
                                    </form>
                ...
                <div class="modal fade" id="inspect_member" tabindex="-1" role="dialog" aria-labelledby="inspect_member" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="m-4 justify-content-end d-flex">
                                <button type="submit" class="btn btn-info mx-2" data-dismiss="modal" data-toggle="modal" data-target="#edit_member" onclick="smCheck()">編輯</button>
                                <button type="submit" class="btn btn-warning mx-2" data-dismiss="modal" data-toggle="modal" data-target="#delete" onclick="smDelete()">刪除</button>
                                <button type="button" class="btn btn-secondary mx-2" data-dismiss="modal">取消</button>
