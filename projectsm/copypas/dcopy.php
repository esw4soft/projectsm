            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-start">
                        ...
                        <h3 class="text-danger my-lg-1 pl-5 ml-5" id="alert1"><?php
                    ...
                    <form>
                        <div class="form-check form-check-inline mb-4">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="auth_id">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex align-content-center justify-content-between">
                            ...
                            <button class="btn btn-danger mt-6 py-0" type="submit" >刪除所選項目</button>
                        </div>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                <li class="page-item">
                                    <a class="page-link" href="tempauth.php?page=<?php if($page!=1){echo($page-1);}else{echo $page=1;}?>&searchdata=<?= $searchdata?>" aria-label="Previous">
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="tempauth.php?page=<?php if($page<$total_page){echo ($page+1);}else{echo $page=1;}  ?>&searchdata=<?= $searchdata?>" aria-label="Next">
