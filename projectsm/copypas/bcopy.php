...
$sql_page = "SELECT * FROM authority WHERE valid=1 ORDER BY admin_id DESC LIMIT $start, $item_per_page";
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php while ($row = $result_page->fetch_assoc()) {
                                            $test1 = $row["admin_id"];  ?>
                                            <tr>
                                                <th id="<?=$test1?>" scope="row" class="text-center"><?= $row["admin_id"] ?></th>
                                                <th class="text-nowrap text-center"><?= $row["admin_name"] ?></td>
                                                <th scope="col" class="text-nowrap text-left"><?= $row["admin_account"] ?></th>
                                                <th scope="col" class="text-nowrap text-left"><?= $row["admin_password"] ?></th>
                                                <th scope="col" class="text-nowrap text-left"><?= $row["admin_email"] ?></th>
                                                <th scope="col" class="text-nowrap text-center"><?= $row["admin_authority"] ?></th>
                                                <th scope="col" class="text-nowrap text-center"><?= $row["admin_create_date"] ?></th>
                                                <th scope="col" class="text-nowrap text-center"><?= $row["admin_edit_date"] ?></th>
                                                <th scope="col" class="text-nowrap text-center"><?= $row["valid"] ?></th>
                                                <th scope="col d-flex edit" class="text-nowrap text-center">

                                                    <button class="btn btn-info my-2 my-sm-0 py-0 mr-1" type="button" data-toggle="modal" data-target="#edit_authority" onclick="dologin(<?php echo $test1;?>)">修改</button>

                                                    <button class="btn btn-warning my-2 my-sm-0 py-0" type="submit" data-toggle="modal" data-target="#delete">刪除</button>
                                                </th>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <ul class="pagination justify-content-center">
                                ...
                                <?php for ($i = 1; $i <= $total_page; $i++) { ?>
                                    ...
                                    <li class="page-item <?php if ($page == $i) {
                                        ...
                                        <a class="page-link" href="tempauth.php?page=<?= $i ?>"><?= $i ?></a>
                                    </li>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid" style="padding-bottom: 3rem">
                                        ...
                                        <form action="authority_update.php" method="post">
                                            ...
                                            <div class="form-group col-8">
                                                <label for="authority_account">管理員帳號</label>
                                                <input type="text" class="form-control" id="authority_account2" name="authaccount" required>
                                            </div>
                                            <div class="form-group col-8">
                                                <label for="authority_password">管理員密碼</label>
                                                <input type="password" class="form-control" id="authority_password2" name="authpass" required>
                                            </div>
                                            <div class="form-group col-10">
                                                <label for="authority_email">管理員信箱</label>
                                                <input type="email" class="form-control" id="authority_email2" aria-describedby="emailHelp" name="authemail" required>
                                            </div>
                                            <div class="form-group col-6">
                                                <label for="authority">權限等級(1~3)</label>
                                                <input type="text" pattern="[1-3]{1}" class="form-control" id="authority2" name="authlevel" required>
                                            </div>

                                            <div class="form-group col-8">
                                                <label for="authority_editdate">修改日期 </label>
                                                <input type="date" class="form-control" id="authority_editdate2" name="authedate" required>
                                            </div>
