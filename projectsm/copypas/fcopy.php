                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            <div class="d-flex align-content-center mb-3"> <h6 class="m-0 p-0 font-weight-bold text-primary col-5">權限管理列表</h6>
                            <button class="btn btn-outline-primary my-sm-0 py-0 col-2" type="button" data-toggle="modal" data-target="#create_member">+ 新增權限管理</button></div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive-sm">
                                <table class="table table-bordered table-striped" width="90%" cellspacing="0">
