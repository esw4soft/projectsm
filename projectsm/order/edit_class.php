...
$sql_list = "SELECT * FROM s_class WHERE order_id=$o_id";
$result_list = $conn->query($sql_list);

$row= $result_list ->fetch_assoc();
$arr =array(
    "e_order_id"=> $row["order_id"],
    "e_class_name"=> $row["class_name"],
...
// )VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
// $stmt->bind_param('sisssssssss',$class_name, $purchaser_id, $purchaser_name
