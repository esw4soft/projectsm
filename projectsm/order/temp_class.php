                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 my-4">
                        ...
                        <div class="d-flex align-content-center justify-content-between">
                                ...
                                <button class="btn btn-danger my-2 my-sm-0 p-0 px-1"
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid" style="padding-bottom: 3rem">
                                            ...
                                            <!-- <div class="form-group col-10">
                                                ...
                                                <div class="form-group col-10">
                                                    <label for="e_class_name">活動名稱</label>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <th scope="row" class="text-nowrap">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="selected_all" onclick="select_all(this,'select_class')">
                                        ...
                                        <tr>
                                            <td scope="col" class="text-center">
                                                    <div class="form-check" onclick="select(<?php echo $id; ?>)">
                                                            ...
                                                            <input class="form-check-input position-static" type="checkbox" name="select_class"  id="<?php echo $row["class_id"]?>">
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid" style="padding-bottom: 3rem">
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <div class="form-group col-10">
                                                    <label for="class_name">活動名稱</label>
...
<script>
    function edit_class(test){
        ...
        var selected = [];
        var total;
                    function select_all(member,select_class){
                        var checkboxs = document.getElementsByName(select_class); //抓列表中的每一個框框
